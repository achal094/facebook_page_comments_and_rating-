    ...
    public static void main(String[] args) throws IOException {
      ...
      //  FileInputStream fileInputStream = new FileInputStream("workbook.xls");
       ...
       //initialize column headers for page post.
        ...
        style.setBorderTop((short) 25);
        style.setWrapText(true);
        style.setFillBackgroundColor( (short) 555);
		...
		HSSFCell p5 = r1.createCell(4);
		 p1.setCellStyle(style);
		p1.setCellValue("Post ID");
		
		p2.setCellStyle(style);
		p2.setCellValue("Posted By");
		
		 p3.setCellStyle(style); 
		p3.setCellValue("Poster's ID");
		
		 p4.setCellStyle(style);
		p4.setCellValue("Date and Time");
		
		 p5.setCellStyle(style);
		...
		Connection<Post> postfeed = Fb.fetchConnection(page.getId()+"/feed",Post.class, Parameter.with("fields", "id,created_time,message,from"));
			...
			System.out.println("Program run successful. Data is stored in workbook.xls");
       	}
    }
